...
const VipDetails = () => {
  return (
    <section className="w-full h-fit flex py-[109px] justify-center items-center">
      <div className="h-fit max-w-[754px] text-center w-full flex flex-col gap-[29px]">
        <h1 className="font-bold text-5xl">VIP зар</h1>
        <p>
