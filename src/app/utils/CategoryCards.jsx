...
export default function CategoryCards({ name, image }) {
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="size-20 lg:size-52 rounded-full bg-[#f5f5f5] hover:border hover:border-blue-500 transform-all shadow-sm flex items-center justify-center overflow-hidden p-4 lg:p-7">
